...
$stages = [ordered]@{
    unit = @(
        ...
        (Join-Path $testsRoot 'ApiServer.Unit.Tests.ps1'),
        ...
        (Join-Path $testsRoot 'unit\Accessibility.Tests.ps1'),
        (Join-Path $testsRoot 'unit\ThemeManager.Tests.ps1'),
        (Join-Path $testsRoot 'unit\ThemeEngine.Tests.ps1'),
        (Join-Path $testsRoot 'unit\ConsoleDetection.PipelineCoverage.Tests.ps1'),
        (Join-Path $testsRoot 'unit\RuleEngine.Tests.ps1'),
        (Join-Path $testsRoot 'unit\RomFilter.Tests.ps1'),
        (Join-Path $testsRoot 'unit\SetParsing.EdgeCase.Tests.ps1'),
        (Join-Path $testsRoot 'unit\SetParsing.MdsMdf.Tests.ps1'),
        (Join-Path $testsRoot 'unit\ArchiveSecurity.Tests.ps1'),
        (Join-Path $testsRoot 'unit\CommandPalette.Tests.ps1'),
        (Join-Path $testsRoot 'unit\KeyboardShortcuts.Tests.ps1'),
        (Join-Path $testsRoot 'unit\CloneListViewer.Tests.ps1'),
        (Join-Path $testsRoot 'unit\SplitPanelPreview.Tests.ps1'),
        (Join-Path $testsRoot 'unit\VirtualFolderPreview.Tests.ps1'),
        (Join-Path $testsRoot 'unit\DuplicateHeatmap.Tests.ps1'),
        (Join-Path $testsRoot 'unit\TrendAnalysis.Tests.ps1'),
        (Join-Path $testsRoot 'unit\WpfWizard.Tests.ps1'),
        (Join-Path $testsRoot 'unit\WpfTrashSettings.Tests.ps1'),
        (Join-Path $testsRoot 'unit\WpfUnhandledExceptionHooks.Tests.ps1'),
