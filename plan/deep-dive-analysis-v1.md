...
- [ ] **INFO:** DryRun-Semantik dokumentieren — DryRun simuliert nur, prüft keine Zwischenergebnisse
...
- [ ] **FIX:** `IFileSystem` um `MoveDirectorySafely` erweitern oder in `MoveItemSafely` Verzeichnisse unterstützen
...
- [ ] **FIX:** PBP-Konvertierung in `Verify` ergänzen (kann über chdman verify des Outputs gehen)
