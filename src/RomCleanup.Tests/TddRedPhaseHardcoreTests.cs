...
public class TddRedPhaseHardcoreTests : IDisposable
{
    ...
    {
        var converter = new RomCleanup.Infrastructure.Conversion.FormatConverterAdapter(
    ...
    public void Enrichment_Cancel_MustThrowOperationCanceled()
    {
        ...
        var context = new PipelineContext
        {
            ...
            FileSystem = new RomCleanup.Infrastructure.FileSystem.FileSystemAdapter(),
            AuditStore = new NullAuditStore(),
            Metrics = new PhaseMetricsCollector()
        };
    ...
    /// </summary>
    private sealed class MinimalToolRunner : RomCleanup.Contracts.Ports.IToolRunner
    {
