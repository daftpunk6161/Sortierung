...
public sealed class FeatureServiceCoverageTests
{
    ...
    {
        var vm = new RomCleanup.UI.Wpf.ViewModels.DatCatalogItemVm { Status = status };
    ...
    {
        var vm = new RomCleanup.UI.Wpf.ViewModels.DatCatalogItemVm { FileSizeBytes = bytes };
    ...
    {
        var vm = new RomCleanup.UI.Wpf.ViewModels.DatCatalogItemVm
        {
    ...
    {
        var vm = new RomCleanup.UI.Wpf.ViewModels.DatCatalogItemVm { Status = DatInstallStatus.Installed };
    ...
    {
        var vm = new RomCleanup.UI.Wpf.ViewModels.DatCatalogItemVm { Status = DatInstallStatus.Missing };
        var changed = new List<string>();
        vm.PropertyChanged += (_, e) => changed.Add(e.PropertyName!);
