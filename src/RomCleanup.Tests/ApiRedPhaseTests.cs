...
public sealed class ApiRedPhaseTests : IDisposable
{
    ...
    /// Betroffene Dateien: src/RomCleanup.Api/Program.cs (GET /health endpoint)
    /// </summary>
    [Fact]
    ...
    /// Betroffene Dateien: src/RomCleanup.Api/RunManager.cs (ApiRunResult, ExecuteWithOrchestrator)
    /// </summary>
    [Fact]
    ...
    /// Betroffene Dateien: src/RomCleanup.Api/RunManager.cs (ApiRunResult),
    ...
    /// Betroffene Dateien: src/RomCleanup.Api/RunManager.cs (RunRecord),
    ///   src/RomCleanup.Api/Program.cs (GET /runs/{id})
    /// </summary>
    [Fact]
    ...
    /// Betroffene Dateien: src/RomCleanup.Api/Program.cs (POST /runs/{id}/cancel)
    /// </summary>
    [Fact]
    ...
    //  Fix target: src/RomCleanup.Api/Program.cs (SSE terminalEvent switch).
    // ═══════════════════════════════════════════════════════════════════
    ...
    /// Betroffene Dateien: src/RomCleanup.Api/Program.cs (SSE /runs/{id}/stream switch)
    /// </summary>
    [Fact]
    ...
    /// Betroffene Dateien: src/RomCleanup.Api/RunManager.cs (ApiRunResult.Error,
    ...
    /// Betroffene Dateien: src/RomCleanup.Api/RunManager.cs (ExecuteRun catch-Block)
    /// </summary>
    [Fact]
    ...
    //  Fix target: src/RomCleanup.Api/Program.cs (SSE + GET /runs/{id}).
    // ═══════════════════════════════════════════════════════════════════
    ...
    /// Betroffene Dateien: src/RomCleanup.Api/RunManager.cs (RunRecord),
    ///   src/RomCleanup.Api/Program.cs (SSE status event serialization)
    /// </summary>
    [Fact]
    ...
    /// Betroffene Dateien: src/RomCleanup.Api/Program.cs (POST /runs wait=true OK path)
    /// </summary>
    [Fact]
    ...
    //  Fix target: src/RomCleanup.Api/Program.cs (middleware order, error shape).
    // ═══════════════════════════════════════════════════════════════════
    ...
    /// Betroffene Dateien: src/RomCleanup.Contracts/Errors/OperationErrorResponse.cs,
    ///   src/RomCleanup.Api/Program.cs (CreateErrorResponse)
    /// </summary>
    [Fact]
    ...
    /// Betroffene Dateien: src/RomCleanup.Api/Program.cs (middleware order)
    /// </summary>
    [Fact]
    ...
    /// Betroffene Dateien: src/RomCleanup.Api/Program.cs (rate limit middleware),
    ///   src/RomCleanup.Api/RateLimiter.cs
    /// </summary>
    [Fact]
    ...
    //  Fix target: src/RomCleanup.Api/RunManager.cs (RunRequest, RunRecord,
    ...
    /// Betroffene Dateien: src/RomCleanup.Api/RunManager.cs (RunRequest, RunRecord,
    ...
    /// Betroffene Dateien: src/RomCleanup.Api/RunManager.cs (ApiRunResult),
    ///   src/RomCleanup.Api/Program.cs (POST /runs result shape)
    /// </summary>
    [Fact]
    ...
    /// Betroffene Dateien: src/RomCleanup.Api/Program.cs (POST /runs validation),
    ///   src/RomCleanup.Api/RunManager.cs (RunRequest)
    /// </summary>
    [Fact]
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), "RomCleanup_ApiRed_" + Guid.NewGuid().ToString("N"));
