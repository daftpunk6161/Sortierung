...
public sealed class CliRedPhaseTests : IDisposable
{
    ...
    //  Fix target: src/RomCleanup.CLI/Program.cs  ParseArgs switch cases.
    // ═══════════════════════════════════════════════════════════════════
    ...
    //  Fix target: src/RomCleanup.CLI/Program.cs  ParseArgs value reads.
    // ═══════════════════════════════════════════════════════════════════
    ...
    //  Fix target: src/RomCleanup.CLI/Program.cs  Run method.
    // ═══════════════════════════════════════════════════════════════════
    ...
    //  Fix target: src/RomCleanup.CLI/Program.cs + RunOrchestrator.
    // ═══════════════════════════════════════════════════════════════════
    ...
    //  Fix target: src/RomCleanup.CLI/Program.cs  DryRun JSON block.
    // ═══════════════════════════════════════════════════════════════════
