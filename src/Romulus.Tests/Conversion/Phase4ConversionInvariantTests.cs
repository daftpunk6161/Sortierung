...
public sealed class Phase4ConversionInvariantTests
{
    ...
    {
        var envDir = Environment.GetEnvironmentVariable("ROMULUS_DATA_DIR");
    ...
    public void R06_DolphinToolInvoker_Verify_UsesDolphinToolVerify()
    {
        ...
        var invoker = new Romulus.Infrastructure.Conversion.ToolInvokers.DolphinToolInvoker(toolRunner);
