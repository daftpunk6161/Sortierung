...
public sealed class TempFileCleanupConventionTests
{
    ...
    [
        ...
        "Benchmark/GroundTruthParsingRedTests.cs",
        "Benchmark/PerformanceBenchmarkTests.cs",
        "Benchmark/RegressionDetectionRedTests.cs",
        "Benchmark/TrendAndCrossValidationTests.cs",
