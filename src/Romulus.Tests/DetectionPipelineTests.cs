...
public sealed class DetectionPipelineTests
{
    ...
    private static void WriteGbaNintendoLogo(byte[] data)
    {
        byte[] logo =
        [
        ...
        logo.CopyTo(data.AsSpan(0x04));
    }

    private static void WriteGbNintendoLogo(byte[] data)
    {
        byte[] logo =
        [
