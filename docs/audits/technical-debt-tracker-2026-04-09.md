...
- [ ] TD-008 - Competing status-string constant sources (3 parallel definitions)
  ...
  Evidence: src/RomCleanup.Contracts/RunConstants.cs:67-79 (StatusOk="ok", StatusBlocked, StatusCancelled, StatusFailed), src/RomCleanup.Api/ApiRunStatus.cs:4-11 (Running="running", Completed="completed", CompletedWithErrors, Blocked, Cancelled, Failed), src/RomCleanup.Contracts/Models/OperationResult.cs:55-58 (StatusOk="ok", StatusBlocked="blocked")
...
- [ ] TD-009 - Hardcoded status magic strings bypass existing constants
  ...
  Evidence: src/RomCleanup.Api/Program.cs (6x "running" literal), src/RomCleanup.Api/RunManager.cs:375 (Status != "running"), src/RomCleanup.UI.Wpf/Models/DashboardProjection.cs:151-152 ("cancelled"/"failed" literals), src/RomCleanup.UI.Wpf/Models/ErrorSummaryProjection.cs:45 ("blocked" literal), src/RomCleanup.UI.Wpf/ViewModels/MainViewModel.RunPipeline.cs:1180 ("cancelled" literal)
...
- [ ] TD-010 - Identical 76-line code duplication in API error classification
  ...
  Evidence: src/RomCleanup.Api/ProgramHelpers.cs:509-585 (both methods with 11 identical message.Contains() checks each)
...
- [ ] TD-011 - Fragile string-based error classification in API
  ...
  Evidence: src/RomCleanup.Api/ProgramHelpers.cs:510-547 (Contains("protected system path"), Contains("drive root"), Contains("UNC path"), Contains("Invalid region"), etc.)
...
- [ ] TD-012 - I/O dependencies in RomCleanup.Core (architecture violation)
  ...
  Acceptance Criteria: RomCleanup.Core has zero direct System.IO references in production code paths.
...
- [ ] TD-013 - Hardcoded German strings in WPF dialog handlers (i18n bypass)
  ...
  Evidence: src/RomCleanup.UI.Wpf/Services/FeatureCommandService.Infra.cs:114 ("Hardlink-Modus", "Verfügbar"/"Nicht verfügbar", "Speicherplatz"), src/RomCleanup.UI.Wpf/Services/FeatureCommandService.Security.cs:113 ("Integritäts-Baseline erstellen oder prüfen?"), src/RomCleanup.UI.Wpf/Services/FeatureService.Export.cs:141-143 ("Benutzerdefinierte Regeln", "Erstelle Regeln mit Bedingungen"), src/RomCleanup.UI.Wpf/Services/FeatureCommandService.Dat.cs:276,327, src/RomCleanup.UI.Wpf/Services/FeatureCommandService.Workflow.cs:117,138,157
...
- [ ] TD-014 - RVZ magic-byte verification duplicated in two converters
  ...
  Evidence: src/RomCleanup.Infrastructure/Conversion/ToolInvokerAdapter.cs:185-198 (VerifyRvz method), src/RomCleanup.Infrastructure/Conversion/ToolInvokers/DolphinToolInvoker.cs:92-103 (identical magic check inline)
...
- [ ] TD-015 - Sort decision magic strings not centralized
  ...
  Evidence: src/RomCleanup.Infrastructure/Sorting/ConsoleSorter.cs:63,150,212,271
...
- [ ] TD-016 - Sync-over-async remains (7 blocking hotspots)
  ...
  Evidence: src/RomCleanup.CLI/Program.cs:277,747,855 (3x), src/RomCleanup.CLI/CliOptionsMapper.cs:38,60 (2x), src/RomCleanup.Api/Program.cs:1916 (shutdown handler), src/RomCleanup.Api/RunManager.cs:126 (1x)
...
- [ ] TD-017 - DateTime.UtcNow used directly (30+ sites) without TimeProvider
  ...
  Evidence: src/RomCleanup.Api/RunLifecycleManager.cs (7x), src/RomCleanup.Api/RateLimiter.cs (2x), src/RomCleanup.Api/RunManager.cs (3x), src/RomCleanup.Api/Program.cs (10+x), src/RomCleanup.UI.Wpf/ViewModels/MainViewModel.RunPipeline.cs (4x)
...
- [ ] TD-018 - new HttpClient() directly instantiated (socket exhaustion risk)
  ...
  Evidence: src/RomCleanup.Infrastructure/Dat/DatSourceService.cs:38
...
- [ ] TD-019 - Thread.Sleep in production code blocks threads
  ...
  Evidence: src/RomCleanup.UI.Wpf/Services/ProfileService.cs:36,40 (2x, 25*attempt backoff), src/RomCleanup.Infrastructure/Configuration/SettingsFileAccess.cs:39
...
- [ ] TD-020 - Empty catch(IOException) blocks suppress errors silently (10 sites)
  ...
  Evidence: src/RomCleanup.Core/Classification/DiscHeaderDetector.cs:74,99 (2x), src/RomCleanup.Core/Classification/CartridgeHeaderDetector.cs:64,202 (2x), src/RomCleanup.Core/Classification/ConsoleDetector.cs:550, src/RomCleanup.Infrastructure/Deduplication/FolderDeduplicator.cs:67, src/RomCleanup.Infrastructure/Conversion/ConversionExecutor.cs:415,422 (2x), src/RomCleanup.UI.Wpf/ViewModels/DatCatalogViewModel.cs:210,367 (2x)
...
- [ ] TD-021 - Hardcoded C:\tools\conversion fallback path
  ...
  Evidence: src/RomCleanup.Infrastructure/Tools/ToolRunnerAdapter.cs:20
...
- [ ] TD-022 - Hardcoded dolphintool compression parameters
  ...
  Evidence: src/RomCleanup.Infrastructure/Conversion/ToolInvokerAdapter.cs:133-142, src/RomCleanup.Infrastructure/Conversion/ToolInvokers/DolphinToolInvoker.cs:50
...
- [ ] TD-023 - CLI Help text uses magic number for stale-days default
  ...
  Evidence: src/RomCleanup.CLI/CliOutputWriter.cs:185
...
- [ ] TD-024 - SHA1 as default hash algorithm (weak cryptographic default)
  ...
  Evidence: src/RomCleanup.Infrastructure/Hashing/FileHashService.cs:210 (_ => SHA1.Create())
...
- [ ] TD-025 - Conversion preview vs execute parity untested
  ...
  Evidence: src/RomCleanup.Tests/PreviewExecuteParityTests.cs (covers GroupCount, WinnerCount, ConsoleSortResult but no ConvertedCount parity assertion)
...
- [ ] TD-026 - No cross-validation between consoles.json and conversion-registry.json
  ...
  Evidence: src/RomCleanup.Infrastructure/Conversion/ConversionRegistryLoader.cs:127,191
...
- [ ] TD-027 - AppStateStore.Get() returns mutable dictionary beyond lock scope
  ...
  Evidence: src/RomCleanup.Infrastructure/State/AppStateStore.cs (Get() creates shallow copy as Dictionary)
...
- [ ] TD-028 - GameKeyNormalizer non-atomic volatile dual-field registration (race condition)
  ...
  Evidence: src/RomCleanup.Core/GameKeys/GameKeyNormalizer.cs:27-45 (volatile + lock pattern), Normalize() at :107 reads both fields without lock
...
- [ ] TD-029 - Region detection rules hardcoded in C# instead of data-driven (shadow logic)
  ...
  Evidence: src/RomCleanup.Core/Regions/RegionDetector.cs:34-65 (DefaultOrderedRules, 25 hardcoded regexes), :226-287 (RegionTokenMap, 100+ hardcoded entries)
...
- [ ] TD-030 - FormatScorer 40+ format scores hardcoded as C# switch statement
  ...
  Evidence: src/RomCleanup.Core/Scoring/FormatScorer.cs:9-60 (DiscExtensions + GetFormatScore switch with 40+ entries)
...
- [ ] TD-031 - DatSourceService ReadAsByteArrayAsync loads full response before size check
  ...
  Evidence: src/RomCleanup.Infrastructure/Dat/DatSourceService.cs:112-113 (Content-Length check + ReadAsByteArrayAsync)
...
- [ ] TD-032 - AuditSigningService HMAC key file left with loose permissions on failure
  ...
  Evidence: src/RomCleanup.Infrastructure/Audit/AuditSigningService.cs:90-93 (catch swallows permission error, logs warning, continues using key)
...
- [ ] TD-033 - AuditSigningService rollback loads entire audit CSV into memory
  ...
  Evidence: src/RomCleanup.Infrastructure/Audit/AuditSigningService.cs:268 (File.ReadAllLines)
...
- [ ] TD-034 - Language codes triple-hardcoded (RegionDetector + VersionScorer + rules.json)
  ...
  Evidence: src/RomCleanup.Core/Regions/RegionDetector.cs:242-250 (LanguageCodes + EuLanguageCodes), src/RomCleanup.Core/Scoring/VersionScorer.cs:32-33 (langPattern regex with all codes), data/rules.json (language definitions)
...
- [ ] TD-035 - DeduplicationEngine BuildGroupKey uses "||" separator (collision risk)
  ...
  Evidence: src/RomCleanup.Core/Deduplication/DeduplicationEngine.cs:95-98 (BuildGroupKey with "||" separator)
...
- [ ] TD-036 - WPF PropertyChanged event handler leaks on collection items
  ...
  Evidence: src/RomCleanup.UI.Wpf/ViewModels/MainViewModel.cs:379,489 (+= OnExtensionCheckedChanged, += OnConsoleCheckedChanged), src/RomCleanup.UI.Wpf/ViewModels/MainViewModel.RunPipeline.cs:1417 (+= OnExtensionFilterChanged). No corresponding -= before Clear().
...
- [ ] TD-037 - HealthScorer magic numbers not configurable (business KPI weights in code)
  ...
  Evidence: src/RomCleanup.Core/Scoring/HealthScorer.cs:11-16 (all weights hardcoded)
...
- [ ] TD-038 - DeduplicationEngine category rank hardcoded (business rule in code)
  ...
  Evidence: src/RomCleanup.Core/Deduplication/DeduplicationEngine.cs:51-59 (GetCategoryRank switch)
...
- [ ] TD-039 - SafetyValidator IsProtectedSystemPath allocates array on every call
  ...
  Evidence: src/RomCleanup.Infrastructure/Safety/SafetyValidator.cs:340-351 (new[] { ... }.Where().ToArray() on every call)
...
- [ ] TD-040 - SafetyValidator EnsureNoReparsePointInExistingAncestry no max depth guard
  ...
  Evidence: src/RomCleanup.Infrastructure/Safety/SafetyValidator.cs:418-459 (while loop without max iterations)
...
- [ ] TD-041 - Child ViewModels created inline without DI container
  ...
  Evidence: src/RomCleanup.UI.Wpf/ViewModels/MainViewModel.cs:87-98 (new ShellViewModel, new SetupViewModel, new ToolsViewModel, etc.)
...
- [ ] TD-042 - MovePipelinePhase rollback failure only logged as WARNING
  ...
  Evidence: src/RomCleanup.Infrastructure/Orchestration/MovePipelinePhase.cs:230-280 (set member rollback loop, warning-only on failure)
...
- [ ] TD-044 - SettingsFileAccess exponential backoff can block up to ~3s without global timeout
  ...
  Evidence: src/RomCleanup.Infrastructure/Configuration/SettingsFileAccess.cs:10-30 (DefaultMaxAttempts=8, InitialDelayMs=25, doubling)
...
- [ ] TD-045 - Test stubs with empty no-op implementations (alibi mocks)
  ...
  Evidence: src/RomCleanup.Tests/GuiViewModelTests.cs:2632-2700 (StubDialogService with empty Info(), ShowText(), etc.)
...
- [ ] TD-046 - StreamingScanPipelinePhase swallows async iterator exceptions
  ...
  Evidence: src/RomCleanup.Infrastructure/Orchestration/StreamingScanPipelinePhase.cs:90-110
...
- [ ] TD-047 - UkPattern duplicates DefaultOrderedRules UK detection
  ...
  Evidence: src/RomCleanup.Core/Regions/RegionDetector.cs:152-156 (UkPattern), :57 (UK in DefaultOrderedRules EU entry)
...
- [ ] TD-048 - GameKeyNormalizer DOS metadata loop hardcoded limit of 20
  ...
  Evidence: src/RomCleanup.Core/GameKeys/GameKeyNormalizer.cs:310-316 (for i < 20)
...
- [ ] TD-049 - VersionScorer truncates at 6 version segments without logging
  ...
  Evidence: src/RomCleanup.Core/Scoring/VersionScorer.cs:101-117 (const maxSegments = 6, wasTruncated)
...
- [ ] TD-050 - FormatScorer GetRegionScore O(n) linear search
  ...
  Evidence: src/RomCleanup.Core/Scoring/FormatScorer.cs:68-79 (for loop through preferOrder)
...
- [ ] TD-051 - AllowedRootPathPolicy catch(Exception) too broad
  ...
  Evidence: src/RomCleanup.Infrastructure/Safety/AllowedRootPathPolicy.cs:29-33
...
- [ ] TD-052 - SetupViewModel/MainViewModel property duplication with manual sync
  ...
  Evidence: src/RomCleanup.UI.Wpf/ViewModels/MainViewModel.Settings.cs:68+ (property setters call SyncToSetup), src/RomCleanup.UI.Wpf/ViewModels/SetupViewModel.cs:32+
...
- [ ] TD-053 - DatAuditPipelinePhase ToConfidence default case returns 60 (no exhaustive match)
  ...
  Evidence: src/RomCleanup.Infrastructure/Orchestration/DatAuditPipelinePhase.cs:70-88 (_ => 60)
...
- [ ] TD-054 - SettingsLoader MergeFromDefaults swallows JsonException silently
  ...
  Evidence: src/RomCleanup.Infrastructure/Configuration/SettingsLoader.cs:160-200
