...
- **Datei:** `src/RomCleanup.Api/RunLifecycleManager.cs`
...
- **Datei:** `src/RomCleanup.Infrastructure/Reporting/RunReportWriter.cs`
...
- **Datei:** `src/RomCleanup.Infrastructure/Orchestration/RunOrchestrator.StandardPhaseSteps.cs`
...
- **Datei:** `src/RomCleanup.Infrastructure/Analysis/IntegrityService.cs`
...
- **Datei:** `src/RomCleanup.Infrastructure/Orchestration/RunOptionsBuilder.cs` (Zeile 76–80)
...
- **Datei:** `src/RomCleanup.Infrastructure/Orchestration/RunOptionsBuilder.cs` (Zeile 17–45)
...
- **Datei:** `src/RomCleanup.Infrastructure/Review/LiteDbReviewDecisionStore.cs` (Zeile 195–199)
...
- **Datei:** `src/RomCleanup.UI.Wpf/ViewModels/MainViewModel.RunPipeline.cs` (Zeile 726–737)
...
- **Datei:** `src/RomCleanup.Infrastructure/Orchestration/RunOrchestrator.PreviewAndPipelineHelpers.cs` (Zeile 81)
...
- **Dateien:** `src/RomCleanup.Infrastructure/Orchestration/MovePipelinePhase.cs`, `FileSystemAdapter.cs`
...
- **Datei:** `src/RomCleanup.Infrastructure/FileSystem/FileSystemAdapter.cs` (Zeile 190–194)
...
- **Datei:** `src/RomCleanup.Infrastructure/Tools/ToolRunnerAdapter.cs` (Zeile 342–343)
...
- **Dateien:** `src/RomCleanup.Infrastructure/Dat/DatRepositoryAdapter.cs` (Zeile 239–254), `src/RomCleanup.Infrastructure/Hashing/FileHashService.cs`
...
- **Datei:** `src/RomCleanup.Infrastructure/Orchestration/RunOrchestrator.cs` (Zeile 85–139)
...
- **Datei:** `src/RomCleanup.Infrastructure/Orchestration/RunOrchestrator.cs` (Zeile 103–116)
...
- **Dateien:** `src/RomCleanup.Core/Audit/DatRenamePolicy.cs` (Zeile 10–48), `src/RomCleanup.Infrastructure/Orchestration/DatRenamePipelinePhase.cs` (Zeile 28–72)
...
- **Datei:** `src/RomCleanup.Core/Scoring/HealthScorer.cs` (Zeile 16)
...
- **Dateien:** `src/RomCleanup.Infrastructure/Hashing/FileHashService.cs` (Zeile 473), `src/RomCleanup.Infrastructure/Index/LiteDbCollectionIndex.cs` (Zeile 535)
...
- **Dateien:** `src/RomCleanup.Contracts/RunConstants.cs` (Zeile 11), `src/RomCleanup.Infrastructure/Orchestration/MovePipelinePhase.cs` (Zeile 75), `src/RomCleanup.Infrastructure/FileSystem/FileSystemAdapter.cs` (Zeile 280), `src/RomCleanup.Infrastructure/Sorting/ConsoleSorter.cs`
